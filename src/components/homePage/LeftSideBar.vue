<template>
  <div>
    <ul
      class="default-navigation-links sidebar-navigation-links spec-sidebar-navigation-links"
    >
      <li>
        <a href="/" class="left_bar_link">
          <span class="mr-2">
            <svg
      ...
      <li>
        <a href="/readinglist" class="left_bar_link">
          <span class="mr-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 44 44"
          ...
          Reading List
          <span
            class="js-reading-list-count c-indicator ml-2 self-center"
            data-count="0"
          ></span>
        </a>
      </li>
      ...
      <li>
        <a href="/listings" class="left_bar_link">
          <span class="mr-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 44 44"
      ...
      <li>
        <a href="/pod" class="left_bar_link">
          <span class="mr-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 44 44"
      ...
      <li>
        <a href="/videos" class="left_bar_link">
          <span class="mr-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 44 44"
      ...
      <li>
        <a href="/tags" class="left_bar_link">
          <span class="mr-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 44 44"
      ...
      <li>
        <a href="/faq" class="left_bar_link">
          <span class="mr-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 44 44"
      ...
      <li>
        <a href="https://shop.forem.com" class="left_bar_link">
          <span class="mr-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 44 44"
      ...
      <li>
        <a href="/sponsorships" class="left_bar_link">
          <span class="mr-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 44 44"
      ...
      <li>
        <a href="/contact" class="left_bar_link">
          <span class="mr-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 44 44"
