      ...
      <div class="bg-white border border-gray-300 mb-2 rounded-lg p-12">
        <div class="registration__content text-center mb-6">
          ...
          <p class="registration__description">
            DEV Community 👩‍💻👨‍💻 is a community of 975,913 amazing developers
          </p>
        </div>
        <div class="registration__actions-providers flex flex-col gap-2">
          <button
            name="button"
            type="submit"
            class="crayons-btn flex items-center bg-black w-full rounded-lg p-3 text-white justify-center"
          >
            <svg
              ...
              viewBox="0 0 24 24"
              role="img"
              aria-labelledby="a2ejj29r0faq4ugjd9bntlr538wqv0qh"
              aria-hidden="true"
              class="crayons-icon mr-3"
            >
              <title id="a2ejj29r0faq4ugjd9bntlr538wqv0qh">apple</title>
              <path
                fill="#ffffff"
          ...
          <button
            name="button"
            type="submit"
            class="crayons-btn flex items-center bg-[#0a3e4a] w-full rounded-lg p-3 text-white justify-center"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              version="1.0"
              ...
              role="img"
              aria-labelledby="aekneysgc59a29ql4i4oj1cyr8yw4hfd"
              aria-hidden="true"
              class="crayons-icon mr-3"
            >
              <title id="aekneysgc59a29ql4i4oj1cyr8yw4hfd">forem</title>
              <g
          ...
          >
            <svg
              ...
              viewBox="0 0 24 24"
              role="img"
              aria-labelledby="a7ts90bms4ydp0dz7zrgelwr3tpgexl1"
              aria-hidden="true"
              class="crayons-icon mr-3"
            >
              <title id="a7ts90bms4ydp0dz7zrgelwr3tpgexl1">github</title>
              <path
                fill="#ffffff"
          ...
          <button
            name="button"
            type="submit"
            class="crayons-btn flex items-center bg-[#1da1f2] w-full rounded-lg p-3 text-white justify-center"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              ...
              viewBox="0 0 24 24"
              role="img"
              aria-labelledby="a12urz83o52e3m5ef8913h22gdtvza27"
              aria-hidden="true"
              class="crayons-icon mr-3"
            >
              <title id="a12urz83o52e3m5ef8913h22gdtvza27">twitter</title>
              <path
        ...
        <div class="registration__hr relative text-center">
          <hr class="border-gray-300 border-2 mt-6" />
          <span
            class="registration__hr-label font-light bg-white absolute text-sm top-[-8px] left-[15%] right-[15%]"
          >
            Have a password? Continue with your email address
          </span>
        </div>
        <div class="registration_form mt-6">
          <span class="font-medium">Token</span>

          <div
            class="flex-1 border p-2 rounded-md mt-1 flex items-center hover:border-gray-700 focus:border-blue-700"
          >
            <input
              type="text"
              name="q"
        ...
        <div
          class="registration_actions flex flex-col items-center justify-center pt-10"
        >
          <button
            name="button"
            type="submit"
          ...
          <div class="pt-6">
            <a href="#" class="text-blue-700 text-center text-sm">
